...
function DeleteAppointment(props) {
  ...
  return (
    <Card style={{ marginLeft: "10px", marginRight: "10px", marginTop: "10px" }}>
      <CardHeader
        title={<Typography color="primary" ><Link to="/DeleteAppointmentTable"  style={{color:"currentcolor",textDecoration:"blink"}}>Delete Appointment </Link></Typography>
      }
        avatar={<Avatar className={classes.bigAvatar} src={deleteIcon} />}
      />
...
export default withStyles(styles)(DeleteAppointment);
