...
function TelemedicineSessions(props) {
...
<CardHeader
        title={<Typography color="primary" ><Link to="/TelemedicineAppointments"  style={{color:"currentcolor",textDecoration:"blink"}}>Telemedicine Sessions</Link></Typography>
      }
...
export default withStyles(styles)(TelemedicineSessions);
