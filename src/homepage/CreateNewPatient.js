...
function CreateNewPatient(props) {
  const classes = props.classes;
  return (
    <Card style={{ marginLeft: "10px", marginRight: "10px", marginTop: "10px" }}>
      <CardHeader
        title={<Typography color="primary" ><Link to="/NewPatientForm"  style={{color:"currentcolor",textDecoration:"blink"}}>Create New Patient</Link></Typography>
      }
...
export default withStyles(styles)(CreateNewPatient);
