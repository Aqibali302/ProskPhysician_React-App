...
import TelemedicineAppointmentsFilters from "./TelemedicineAppointmentsFilters";
import TelemedicineAppointmentsTableComponent from "./TelemedicineAppointmentsTableComponent";
...
function TelemedicineAppointments() {
        ...
        <Grow {...TransitionProps} id="menu-list-grow1">
          <div>
            ...
            >
              ...
              <TelemedicineAppointmentsFilters />
            </Paper>
          </div>
        </Grow>
      )}
  ...
  return (
    <div className={classes.root}>
      ...
      <TelemedicineAppointmentsTableComponent
